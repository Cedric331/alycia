<script setup lang="ts">
    ...
    onMounted(async () => {
        ...
        if (props.profile.script_url) {
            try {
                // Certains scripts "scan" le DOM immédiatement à l'exécution.
                // On laisse Vue finir le rendu avant l'injection.
        ...
        <div class="min-h-screen bg-black">
            ...
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-black border-x border-b border-gray-800 rounded-b-lg p-4 sm:p-6 lg:p-8 pb-24 sm:pb-28">
                    ...
                    <!-- Zone d'injection attendue par le script (container.selector = "#selector") -->
                    <div id="selector"></div>
    
                    <!-- Bouton secondaire (container.events.click = "#ctadebloquer") -->
                    <button
                        id="ctadebloquer"
                        type="button"
                    ...
                    <!-- CTA de conclusion (container.events.click = "#ctaconclusion") -->
                    <div
                        id="ctaconclusion"
                        class="mt-10 mb-4
                               rounded-2xl border border-gray-800
                               bg-gradient-to-r from-pink-500/15 via-rose-500/15 to-orange-400/15
                               p-5 sm:p-6
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-gray-300 text-sm sm:text-base mt-1">
                                    Clique ici pour afficher le formulaire d'inscription.
                                </p>
                            </div>
    
                            <div class="hidden sm:block">
                                <span class="inline-flex items-center rounded-full bg-white/10 px-3 py-1 text-sm text-white font-semibold">
                                    Ouvrir
                                </span>
                            </div>
                        </div>
